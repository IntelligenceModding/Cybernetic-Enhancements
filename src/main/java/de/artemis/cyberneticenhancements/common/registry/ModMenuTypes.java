...
public final class ModMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<TechstationMenu>> TECHSTATION =
            MENU_TYPES.register("techstation", () -> IMenuTypeExtension.create(TechstationMenu::new));
